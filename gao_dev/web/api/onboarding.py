    ...
    try:
        ...
        if config.initialize_git:
            ...
            if config.author_name:
                git_manager.set_config("user.name", config.author_name, local=True)
            if config.author_email:
                git_manager.set_config("user.email", config.author_email, local=True)
            ...
            if config.create_initial_commit:
                ...
                logger.info("initial_commit_created")
