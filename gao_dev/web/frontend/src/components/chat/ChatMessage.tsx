/**
 * ChatMessage - Individual chat message with markdown rendering
 *
 * Story 39.7: Chat component with markdown support
 */
...
export function ChatMessage({ message, showReasoning = false }: ChatMessageProps) {
      ...
      <div className="flex-1 overflow-hidden">
        ...
        <div className="mb-1 flex items-baseline gap-2">
          <span className="text-sm font-semibold">
            {isUser ? 'You' : isAgent ? message.agentName || 'Agent' : 'System'}
          </span>
