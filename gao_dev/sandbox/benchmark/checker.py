...
class CheckResult:
    ...
    def passed(self) -> bool:
        ...
        return all(
            r.status
            in (CriterionStatus.PASSED, CriterionStatus.SKIPPED, CriterionStatus.WARNING)
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {"passed": self.passed, "criteria_results": [asdict(r) for r in self.criteria_results]}
...
class SuccessCriteriaChecker:
    ...
    def _check_test_coverage(
        self, metrics: BenchmarkMetrics, criteria: SuccessCriteria, result: CheckResult
    ) -> None:
        """Check test coverage criterion."""
        actual_coverage = metrics.quality.code_coverage_percentage
    ...
    def _check_manual_interventions(
        ...
        actual_interventions = metrics.autonomy.manual_interventions_count
    ...
    def _check_errors(
        ...
        actual_errors = metrics.quality.linting_errors_count + metrics.quality.type_errors_count
